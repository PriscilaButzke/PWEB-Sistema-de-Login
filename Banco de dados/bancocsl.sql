...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09-Nov-2022 às 01:49
...
--
-- Banco de dados: `bancocsl`
--
CREATE DATABASE IF NOT EXISTS `bancocsl` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bancocsl`;
